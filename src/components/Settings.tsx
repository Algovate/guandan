                ...
                <div className="relative z-10">
                  ...
                  <div className="flex justify-between items-center px-4 py-3 border-b border-white/10">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      onClick={toggleSettings}
                      className="w-7 h-7 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center text-white text-lg font-bold transition-colors border border-white/10"
                    >
                      ×
                    </motion.button>
                  </div>
